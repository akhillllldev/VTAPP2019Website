...
var pov = {
  ...
  upd: function() {
    ...
    pov.ang.phic =
      -pov.dst.z / Math.sqrt(pov.dst.x * pov.dst.x + pov.dst.z * pov.dst.z);
    pov.ang.phis =
      pov.dst.x / Math.sqrt(pov.dst.x * pov.dst.x + pov.dst.z * pov.dst.z);
    pov.ang.thetac =
      Math.sqrt(pov.dst.x * pov.dst.x + pov.dst.z * pov.dst.z) /
      Math.sqrt(
        pov.dst.x * pov.dst.x + pov.dst.y * pov.dst.y + pov.dst.z * pov.dst.z
      );
    pov.ang.thetas =
      -pov.dst.y /
      Math.sqrt(
